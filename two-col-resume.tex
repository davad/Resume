...
\section{\textsc{Skills}}
	...
	\begin{tabular}{p{8cm}}
      Languages: Matlab, LabVIEW, Igor, PHP, C\#.Net, Javascript, Java, Ruby, Python, SQL (MySQL, PostgreSQL), HTML, CSS, SASS, \\\\
    Framework/CMS: Node.js, Rails, Drupal (6, \& 7), CakePHP\\\\
...
\section{\textsc{Research}}
  ...
  \normalsize{%
    Current project involves utilizing high-electric fields to affect protein luminescence.
    Have also worked on designing and building novel protein sensors.
    Work done includes microfabrication, designing and running experiments.
  }\\[10pt]
